...
def test_min_columns_with_reduced_columns():
    ...
    expected_error_name_counts = Counter(
        (
            ...
            r"Value '1' in column 'characteristics[age]' does not match the required pattern: ^(?:(?:\d+[yY])(?:\d+[mM])?(?:\d+[dD])?|(?:\d+[yY])?(?:\d+[mM])(?:\d+[dD])?|(?:\d+[yY])?(?:\d+[mM])?(?:\d+[dD])|(?:(?:\d+[yY])(?:\d+[mM])?(?:\d+[dD])?-(?:\d+[yY])(?:\d+[mM])?(?:\d+[dD])?)|(?:(?:\d+[yY])?(?:\d+[mM])(?:\d+[dD])?-(?:\d+[yY])?(?:\d+[mM])(?:\d+[dD])?)|(?:(?:\d+[yY])?(?:\d+[mM])?(?:\d+[dD])-(?:\d+[yY])?(?:\d+[mM])?(?:\d+[dD]))|(?:not available)|(?:not applicable))$",
        )
    )
